...
public class BaseAPITest {
    ...
    public static void setup() {
        ...
        // Azt adjuk meg, hogy minden hostban bízzon meg, attől függetlenül,
        // hogy esetleg az SSl tanúsítvány érvénytelen, lejárt
        // SSL cert kell a HTTPShez
        RestAssured.config = RestAssuredConfig.newConfig().sslConfig(new SSLConfig().relaxedHTTPSValidation()); //kikapcsolja az SSL konfigurációt
