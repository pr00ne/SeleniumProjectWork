...
public class TC4_AccountTest extends BaseAPITest {
    ...
    public void testAccounts() {
        ...
        response.then()
                ...
                .body("[1]. accountType.code", equalTo("SCK"))
                .body("[1]. accountType.category", equalTo("CHK"))
                .body("[1]. accountType.name", equalTo("Standard Checking"));
    }
}
